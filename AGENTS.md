...
* MVP Features
    ...
    * Use `coach-skills` library to parse clinical notes from health coaches and summarized content as a FHIR Bundle and a patient-friendly Personal Health Plan.
